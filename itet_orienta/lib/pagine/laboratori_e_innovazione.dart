      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child:
            Text('La didattica innovativa ed integrata fanno dell’ITET una scuola che guarda al futuro. Le 11 aule attrezzate e laboratori offrono allo studente gli strumenti giusti per sviluppare competenze in ambito informatico e linguistico. I laboratori multimediali infatti offrono la possibilità di studiare le lingue straniere, inserite nel piano di studi, in maniera innovativa. Già dal biennio gli studenti inizieranno ad usare i laboratori per ampliare le proprie conoscenze. Nel piano di studi dei tre corsi si farà uso di questi laboratori più volte: i professori, usando la didattica integrata (soprattutto per informatica ed economia) insegneranno ai propri studenti tutto quello che servirà per riuscire ad affrontare l’esame di quinto.',  textAlign: TextAlign.center,
